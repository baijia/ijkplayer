...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    private OnBufferingUpdateLoggerListener mOnBufferingUpdateLoggerListener;
    ...
    public final void setOnBufferingUpdateLoggerListener(
            OnBufferingUpdateLoggerListener listener) {
        mOnBufferingUpdateLoggerListener = listener;
    }
    ...
    public void resetListeners() {
        ...
        mOnBufferingUpdateLoggerListener = null;
    ...
    protected final void notifyOnBufferingUpdateLog(int percent, int arg1, int arg2) {
        if (mOnBufferingUpdateLoggerListener != null)
            mOnBufferingUpdateLoggerListener.onBufferingUpdateLog(this, percent, arg1, arg2);
    }
