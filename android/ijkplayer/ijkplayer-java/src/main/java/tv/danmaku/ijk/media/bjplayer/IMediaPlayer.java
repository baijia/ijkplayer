...
public interface IMediaPlayer {
    ...
    int MEDIA_BUFFERING_UPDATE = 704;
    ...
    void setOnBufferingUpdateLoggerListener(
    ...
    interface OnBufferingUpdateLoggerListener {
        void onBufferingUpdateLog(IMediaPlayer mp, int percent, int pos, int cached);
    }
