...
import tv.danmaku.ijk.media.bjplayer.annotations.AccessedByNative;
import tv.danmaku.ijk.media.bjplayer.annotations.CalledByNative;
import tv.danmaku.ijk.media.bjplayer.misc.IAndroidIO;
...
import tv.danmaku.ijk.media.bjplayer.pragma.DebugLog;
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_BUFFERING_UPDATE:
                ...
                int cachedDuration = msg.arg2;
//                Log.e("ijkCached", "bufferPosition=" + bufferPosition + ",cachedDuration=" + cachedDuration);
                if (bufferPosition < 0) {
                    bufferPosition = 0;
                }
                ...
                player.notifyOnBufferingUpdateLog((int)percent, (int)bufferPosition, cachedDuration);
                return;
