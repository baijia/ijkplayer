...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    @Override
    public void setOnBufferingUpdateLoggerListener(OnBufferingUpdateLoggerListener listener) {
        if (listener != null) {
            final OnBufferingUpdateLoggerListener finalListener = listener;
            mBackEndMediaPlayer.setOnBufferingUpdateLoggerListener(new OnBufferingUpdateLoggerListener() {
                @Override
                public void onBufferingUpdateLog(IMediaPlayer mp, int percent, int pos, int cached) {
                    finalListener.onBufferingUpdateLog(MediaPlayerProxy.this, percent, pos, cached);
                }
            });
        } else {
            mBackEndMediaPlayer.setOnBufferingUpdateListener(null);
