    ...
    J4A_LOAD_CLASS(tv_danmaku_ijk_media_bjplayer_misc_IMediaDataSource);
    J4A_LOAD_CLASS(tv_danmaku_ijk_media_bjplayer_misc_IAndroidIO);
    J4A_LOAD_CLASS(tv_danmaku_ijk_media_bjplayer_IjkMediaPlayer);
